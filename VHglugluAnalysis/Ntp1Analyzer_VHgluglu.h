...
#ifndef Ntp1Analyzer_VHgluglu_h
#define Ntp1Analyzer_VHgluglu_h

#include "Ntp1Analyzer.h"
#include "TH1F.h"


class Ntp1Analyzer_VHgluglu : public Ntp1Analyzer {

 public:

   Ntp1Analyzer_VHgluglu( const std::string& dataset, const std::string& flags="", TTree* tree=0);
   virtual ~Ntp1Analyzer_VHgluglu();
